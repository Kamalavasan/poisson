...
//
__constant__ int dims_poisson_kernel_stencil[2][4];
static int dims_poisson_kernel_stencil_h[2][4] = {0};

// user function

__global__ void ops_poisson_kernel_stencil(double *__restrict u_p,
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u &&
      n_3 < bounds_3_u) {
    const ACC<double> u(dims_poisson_kernel_stencil[0][0],
                        dims_poisson_kernel_stencil[0][1],
                        dims_poisson_kernel_stencil[0][2],
                        u_p + n_0 + n_1 * dims_poisson_kernel_stencil[0][0] +
                            n_2 * dims_poisson_kernel_stencil[0][0] *
                                dims_poisson_kernel_stencil[0][1] +
                            n_3 * dims_poisson_kernel_stencil[0][0] *
                                dims_poisson_kernel_stencil[0][1] *
                                dims_poisson_kernel_stencil[0][2]);
    ACC<double> u2(dims_poisson_kernel_stencil[1][0],
                   dims_poisson_kernel_stencil[1][1],
                   dims_poisson_kernel_stencil[1][2],
                   u2_p + n_0 + n_1 * dims_poisson_kernel_stencil[1][0] +
                       n_2 * dims_poisson_kernel_stencil[1][0] *
                           dims_poisson_kernel_stencil[1][1] +
                       n_3 * dims_poisson_kernel_stencil[1][0] *
                           dims_poisson_kernel_stencil[1][1] *
                           dims_poisson_kernel_stencil[1][2]);
...
void ops_par_loop_poisson_kernel_stencil_execute(
...
#endif
  if (args[0].dat->size[0] != dims_poisson_kernel_stencil_h[0][0] ||
      args[0].dat->size[1] != dims_poisson_kernel_stencil_h[0][1] ||
      args[0].dat->size[2] != dims_poisson_kernel_stencil_h[0][2] ||
      args[0].dat->size[3] != dims_poisson_kernel_stencil_h[0][3] ||
      args[1].dat->size[0] != dims_poisson_kernel_stencil_h[1][0] ||
      args[1].dat->size[1] != dims_poisson_kernel_stencil_h[1][1] ||
      args[1].dat->size[2] != dims_poisson_kernel_stencil_h[1][2] ||
      args[1].dat->size[3] != dims_poisson_kernel_stencil_h[1][3]) {
    ...
    dims_poisson_kernel_stencil_h[0][3] = args[0].dat->size[3];
    ...
    dims_poisson_kernel_stencil_h[1][3] = args[1].dat->size[3];
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_poisson_kernel_stencil<<<grid, tblock>>>(
        u_p, u2_p, bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u, bounds_2_l,
        bounds_2_u, bounds_3_l, bounds_3_u);
