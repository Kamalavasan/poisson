...
//
__constant__ int dims_poisson_kernel_initialguess[1][4];
static int dims_poisson_kernel_initialguess_h[1][4] = {0};

// user function

__global__ void ops_poisson_kernel_initialguess(double *__restrict u_p,
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u &&
      n_3 < bounds_3_u) {
    ACC<double> u(dims_poisson_kernel_initialguess[0][0],
                  dims_poisson_kernel_initialguess[0][1],
                  dims_poisson_kernel_initialguess[0][2],
                  u_p + n_0 + n_1 * dims_poisson_kernel_initialguess[0][0] +
                      n_2 * dims_poisson_kernel_initialguess[0][0] *
                          dims_poisson_kernel_initialguess[0][1] +
                      n_3 * dims_poisson_kernel_initialguess[0][0] *
                          dims_poisson_kernel_initialguess[0][1] *
                          dims_poisson_kernel_initialguess[0][2]);
...
void ops_par_loop_poisson_kernel_initialguess_execute(
...
#endif
  if (args[0].dat->size[0] != dims_poisson_kernel_initialguess_h[0][0] ||
      args[0].dat->size[1] != dims_poisson_kernel_initialguess_h[0][1] ||
      args[0].dat->size[2] != dims_poisson_kernel_initialguess_h[0][2] ||
      args[0].dat->size[3] != dims_poisson_kernel_initialguess_h[0][3]) {
    ...
    dims_poisson_kernel_initialguess_h[0][3] = args[0].dat->size[3];
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_poisson_kernel_initialguess<<<grid, tblock>>>(
        u_p, bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u, bounds_2_l,
