...
//
__constant__ int dims_poisson_kernel_update[2][4];
static int dims_poisson_kernel_update_h[2][4] = {0};
...
#endif
#else
void ops_par_loop_poisson_kernel_update_execute(
...
#endif
  if (args[0].dat->size[0] != dims_poisson_kernel_update_h[0][0] ||
      args[0].dat->size[1] != dims_poisson_kernel_update_h[0][1] ||
      args[0].dat->size[2] != dims_poisson_kernel_update_h[0][2] ||
      args[0].dat->size[3] != dims_poisson_kernel_update_h[0][3] ||
      args[1].dat->size[0] != dims_poisson_kernel_update_h[1][0] ||
      args[1].dat->size[1] != dims_poisson_kernel_update_h[1][1] ||
      args[1].dat->size[2] != dims_poisson_kernel_update_h[1][2] ||
      args[1].dat->size[3] != dims_poisson_kernel_update_h[1][3]) {
    ...
    dims_poisson_kernel_update_h[0][3] = args[0].dat->size[3];
    ...
    dims_poisson_kernel_update_h[1][3] = args[1].dat->size[3];
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_poisson_kernel_update<<<grid, tblock>>>(
        u2_p, u_p, bounds_0_l, bounds_0_u, bounds_1_l, bounds_1_u, bounds_2_l,
