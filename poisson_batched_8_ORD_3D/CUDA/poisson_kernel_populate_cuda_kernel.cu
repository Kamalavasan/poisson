...
//
__constant__ int dims_poisson_kernel_populate[6][4];
static int dims_poisson_kernel_populate_h[6][4] = {0};
...
void ops_par_loop_poisson_kernel_populate_execute(
...
#endif
  if (args[3].dat->size[0] != dims_poisson_kernel_populate_h[3][0] ||
      args[3].dat->size[1] != dims_poisson_kernel_populate_h[3][1] ||
      args[3].dat->size[2] != dims_poisson_kernel_populate_h[3][2] ||
      args[3].dat->size[3] != dims_poisson_kernel_populate_h[3][3] ||
      args[4].dat->size[0] != dims_poisson_kernel_populate_h[4][0] ||
      args[4].dat->size[1] != dims_poisson_kernel_populate_h[4][1] ||
      args[4].dat->size[2] != dims_poisson_kernel_populate_h[4][2] ||
      args[4].dat->size[3] != dims_poisson_kernel_populate_h[4][3] ||
      args[5].dat->size[0] != dims_poisson_kernel_populate_h[5][0] ||
      args[5].dat->size[1] != dims_poisson_kernel_populate_h[5][1] ||
      args[5].dat->size[2] != dims_poisson_kernel_populate_h[5][2] ||
      args[5].dat->size[3] != dims_poisson_kernel_populate_h[5][3]) {
    ...
    dims_poisson_kernel_populate_h[3][3] = args[3].dat->size[3];
    ...
    dims_poisson_kernel_populate_h[4][3] = args[4].dat->size[3];
    ...
    dims_poisson_kernel_populate_h[5][3] = args[5].dat->size[3];
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_poisson_kernel_populate<<<grid, tblock>>>(
        *dispx, *dispy, u_p, f_p, ref_p, blockidx_start,
#ifdef OPS_MPI
