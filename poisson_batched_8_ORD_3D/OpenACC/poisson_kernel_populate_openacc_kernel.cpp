...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block,
  ...
  int base3 =
      args[3].dat->base_offset + (OPS_instance::getOPSInstance()->OPS_soa
  ...
  base3 = base3 + (OPS_instance::getOPSInstance()->OPS_soa
                       ? args[3].dat->type_size
                       : args[3].dat->elem_size) *
  ...
  if (xdim3 != xdim3_poisson_kernel_populate_h ||
      ydim3 != ydim3_poisson_kernel_populate_h ||
      xdim4 != xdim4_poisson_kernel_populate_h ||
      ydim4 != ydim4_poisson_kernel_populate_h ||
      xdim5 != xdim5_poisson_kernel_populate_h ||
      ydim5 != ydim5_poisson_kernel_populate_h) {
    ...
    ydim4_poisson_kernel_populate = ydim4;
    ydim4_poisson_kernel_populate_h = ydim4;
    xdim5_poisson_kernel_populate = xdim5;
    xdim5_poisson_kernel_populate_h = xdim5;
    ydim5_poisson_kernel_populate = ydim5;
    ydim5_poisson_kernel_populate_h = ydim5;
  }
