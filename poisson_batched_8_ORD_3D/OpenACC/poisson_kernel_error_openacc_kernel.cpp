...
void ops_par_loop_poisson_kernel_error(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_poisson_kernel_error_h ||
      ydim0 != ydim0_poisson_kernel_error_h ||
      xdim1 != xdim1_poisson_kernel_error_h ||
      ydim1 != ydim1_poisson_kernel_error_h) {
    xdim0_poisson_kernel_error = xdim0;
    xdim0_poisson_kernel_error_h = xdim0;
    ydim0_poisson_kernel_error = ydim0;
    ydim0_poisson_kernel_error_h = ydim0;
    xdim1_poisson_kernel_error = xdim1;
    xdim1_poisson_kernel_error_h = xdim1;
    ydim1_poisson_kernel_error = ydim1;
    ydim1_poisson_kernel_error_h = ydim1;
  }
  ...
  poisson_kernel_error_c_wrapper(p_a0, p_a1, p_a2, x_size, y_size, z_size);
