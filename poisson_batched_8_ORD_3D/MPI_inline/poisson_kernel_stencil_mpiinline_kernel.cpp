...
void ops_par_loop_poisson_kernel_stencil(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_poisson_kernel_stencil_h ||
      ydim0 != ydim0_poisson_kernel_stencil_h ||
      xdim1 != xdim1_poisson_kernel_stencil_h ||
      ydim1 != ydim1_poisson_kernel_stencil_h) {
    xdim0_poisson_kernel_stencil = xdim0;
    xdim0_poisson_kernel_stencil_h = xdim0;
    ydim0_poisson_kernel_stencil = ydim0;
    ydim0_poisson_kernel_stencil_h = ydim0;
    xdim1_poisson_kernel_stencil = xdim1;
    xdim1_poisson_kernel_stencil_h = xdim1;
    ydim1_poisson_kernel_stencil = ydim1;
    ydim1_poisson_kernel_stencil_h = ydim1;
  }
  ...
  int base0 =
      args[0].dat->base_offset + (OPS_instance::getOPSInstance()->OPS_soa
  ...
  base0 = base0 + (OPS_instance::getOPSInstance()->OPS_soa
                       ? args[0].dat->type_size
                       : args[0].dat->elem_size) *
  ...
  int base1 =
      args[1].dat->base_offset + (OPS_instance::getOPSInstance()->OPS_soa
  ...
  base1 = base1 + (OPS_instance::getOPSInstance()->OPS_soa
                       ? args[1].dat->type_size
                       : args[1].dat->elem_size) *
  ...
  poisson_kernel_stencil_c_wrapper(p_a0, p_a1, x_size, y_size, z_size);
