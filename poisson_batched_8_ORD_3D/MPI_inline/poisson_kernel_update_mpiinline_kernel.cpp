...
void ops_par_loop_poisson_kernel_update(char const *name, ops_block block,
  ...
  if (xdim0 != xdim0_poisson_kernel_update_h ||
      ydim0 != ydim0_poisson_kernel_update_h ||
      xdim1 != xdim1_poisson_kernel_update_h ||
      ydim1 != ydim1_poisson_kernel_update_h) {
    xdim0_poisson_kernel_update = xdim0;
    xdim0_poisson_kernel_update_h = xdim0;
    ydim0_poisson_kernel_update = ydim0;
    ydim0_poisson_kernel_update_h = ydim0;
    xdim1_poisson_kernel_update = xdim1;
    xdim1_poisson_kernel_update_h = xdim1;
    ydim1_poisson_kernel_update = ydim1;
    ydim1_poisson_kernel_update_h = ydim1;
  }
  ...
  poisson_kernel_update_c_wrapper(p_a0, p_a1, x_size, y_size, z_size);
