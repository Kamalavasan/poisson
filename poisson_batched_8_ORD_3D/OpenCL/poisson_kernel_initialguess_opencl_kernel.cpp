...
void buildOpenCLKernels_poisson_kernel_initialguess(int xdim0, int ydim0) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dydim0_poisson_kernel_initialguess=%d ",
...
void ops_par_loop_poisson_kernel_initialguess(char const *name, ops_block block,
  ...
  buildOpenCLKernels_poisson_kernel_initialguess(xdim0, ydim0);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              1, sizeof(cl_int), (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              2, sizeof(cl_int), (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              3, sizeof(cl_int), (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[2],
                              4, sizeof(cl_int), (void *)&z_size));
