...
void buildOpenCLKernels_poisson_kernel_update(int xdim0, int ydim0, int xdim1,
                                              int ydim1) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dydim0_poisson_kernel_update=%d  "
                "-Dxdim1_poisson_kernel_update=%d  "
                "-Dydim1_poisson_kernel_update=%d ",
...
void ops_par_loop_poisson_kernel_update(char const *name, ops_block block,
  ...
  buildOpenCLKernels_poisson_kernel_update(xdim0, ydim0, xdim1, ydim1);
