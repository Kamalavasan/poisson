...
void buildOpenCLKernels_poisson_kernel_stencil(int xdim0, int ydim0, int xdim1,
                                               int ydim1) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dydim0_poisson_kernel_stencil=%d  "
                "-Dxdim1_poisson_kernel_stencil=%d  "
                "-Dydim1_poisson_kernel_stencil=%d ",
...
void ops_par_loop_poisson_kernel_stencil(char const *name, ops_block block,
  ...
  buildOpenCLKernels_poisson_kernel_stencil(xdim0, ydim0, xdim1, ydim1);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[3],
                              2, sizeof(cl_int), (void *)&base0));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[3],
                              3, sizeof(cl_int), (void *)&base1));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[3],
                              4, sizeof(cl_int), (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[3],
                              5, sizeof(cl_int), (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[3],
                              6, sizeof(cl_int), (void *)&z_size));
