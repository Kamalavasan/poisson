...
void buildOpenCLKernels_poisson_kernel_populate(int xdim3, int ydim3, int xdim4,
                                                int ydim4, int xdim5,
                                                int ydim5) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dydim3_poisson_kernel_populate=%d  "
                "-Dxdim4_poisson_kernel_populate=%d  "
                "-Dydim4_poisson_kernel_populate=%d  "
                "-Dxdim5_poisson_kernel_populate=%d  "
                "-Dydim5_poisson_kernel_populate=%d ",
                pPath, 32, xdim3, ydim3, xdim4, ydim4, xdim5, ydim5);
      else
        sprintf(buildOpts,
...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block,
  ...
  buildOpenCLKernels_poisson_kernel_populate(xdim3, ydim3, xdim4, ydim4, xdim5,
                                             ydim5);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              2, sizeof(cl_mem), (void *)&arg3.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              5, sizeof(cl_double), (void *)&dx));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              6, sizeof(cl_double), (void *)&dy));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              7, sizeof(cl_int), (void *)&base3));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              8, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
