...
static void process_SLR0 (uint512_dt*  arg0, uint512_dt*  arg1,  hls::stream <t_pkt> &in, hls::stream <t_pkt> &out,
...
void Read_write1(
	...
	#pragma HLS INTERFACE depth=4096 m_axi port = arg0 offset = slave bundle = gmem2 max_read_burst_length=256 max_write_burst_length=256
	#pragma HLS INTERFACE depth=4096 m_axi port = arg1 offset = slave bundle = gmem3 max_read_burst_length=256 max_write_burst_length=256
