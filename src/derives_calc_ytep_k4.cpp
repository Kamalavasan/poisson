static void derives_calc_ytep_k4( hls::stream<uint256_dt> &rd_buffer, hls::stream<uint256_dt> &yy_read, hls::stream<uint256_dt> &wr_buffer, hls::stream<uint256_dt> &yy_write, struct data_G data_g){
