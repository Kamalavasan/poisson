...
//			#pragma HLS RESOURCE variable=vyx core=FAddSub_nodsp
		...
		vzz *= invdz;
  		...
  		// YY final 
  		yy_final_arr[2] += mem_wr_k_dt[2] * 0.3333333f;
  		yy_final_arr[5] += mem_wr_k_dt[5] * 0.3333333f;

  		yy_final_arr[3] += mem_wr_k_dt[3] * 0.33333333f;
  		yy_final_arr[6] += mem_wr_k_dt[6] * 0.33333333f;

  		yy_final_arr[4] += mem_wr_k_dt[4] * 0.33333333f;
  		yy_final_arr[7] += mem_wr_k_dt[7] * 0.33333333f;
