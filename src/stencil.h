...
typedef ap_uint<640> uint640_dt;
...
#define MAX_DEPTH_L (MAX_SIZE_X/40)
#define MAX_DEPTH_P (MAX_SIZE_X/40) * MAX_SIZE_X

//user function
#define PORT_WIDTH 40
#define SHIFT_BITS 3
