...
static void stream_convert_512_256(hls::stream<uint512_dt> &in, hls::stream<uint256_dt> &out, const int xdim0_poisson_kernel_stencil, const int base0, int size1, const int count){
	#pragma HLS dataflow
	int end_index = (xdim0_poisson_kernel_stencil >> (SHIFT_BITS+1));
	int end_row = size1+3;
	int base_index = (base0 + ((0-1) * xdim0_poisson_kernel_stencil) -1) >> (SHIFT_BITS+1);
...
static void stream_convert_256_512(hls::stream<uint256_dt> &in, hls::stream<uint512_dt> &out, const int xdim0_poisson_kernel_stencil, const int base0, int size1, const int count){
	#pragma HLS dataflow
	int end_index = (xdim0_poisson_kernel_stencil >> (SHIFT_BITS+1));
	int end_row = size1+3;
	int base_index = (base0 + ((0-1) * xdim0_poisson_kernel_stencil) -1) >> (SHIFT_BITS+1);
...
static void axis2_fifo256(hls::stream <t_pkt> &in, hls::stream<uint256_dt> &out, const int xdim0_poisson_kernel_stencil, const int base0, int size1, const int count){
	#pragma HLS dataflow
...
static void fifo256_2axis(hls::stream <uint256_dt> &in, hls::stream<t_pkt> &out, const int xdim0_poisson_kernel_stencil, const int base0, int size1, const int count){
	#pragma HLS dataflow
	int end_index = (xdim0_poisson_kernel_stencil >> (SHIFT_BITS));
	int end_row = size1+3;
...
static void process_a_row( hls::stream<uint256_dt> &rd_buffer, hls::stream<uint256_dt> &wr_buffer, const int size0, int size1,  const int xdim0_poisson_kernel_stencil, const int count){
	#pragma HLS dataflow
...
void process_SLR0 (const uint512_dt*  arg0, uint512_dt*  arg1, hls::stream <t_pkt> &in, hls::stream <t_pkt> &out,
    ...
    #pragma HLS STREAM variable = streamArray depth = max_depth_16
	...
	stream_convert_512_256(rd_buffer, streamArray[0], xdim0_poisson_kernel_stencil, base0, size1, count);

	process_a_row( streamArray[0], streamArray[1], size0, size1, xdim0_poisson_kernel_stencil, count);

	fifo256_2axis(streamArray[1], out, xdim0_poisson_kernel_stencil, base0, size1, count);
	axis2_fifo256(in, streamArray[2], xdim0_poisson_kernel_stencil, base0, size1, count);

	stream_convert_256_512(streamArray[2], wr_buffer, xdim0_poisson_kernel_stencil, base0, size1, count);
...
//	#pragma HLS INTERFACE s_axilite port = count bundle = control
	...
	process_SLR0(arg0, arg1, in, out, xdim0_poisson_kernel_stencil, base0, xdim0_poisson_kernel_stencil, base0, size0, size1, count);
...
void process_SLR (hls::stream <t_pkt> &in, hls::stream <t_pkt> &out,
	...
	#pragma HLS dataflow
    axis2_fifo256(in, streamArray[0], xdim0_poisson_kernel_stencil, base0, size1, count);
    process_a_row( streamArray[0], streamArray[1], size0, size1, xdim0_poisson_kernel_stencil, count);
    fifo256_2axis(streamArray[1], out, xdim0_poisson_kernel_stencil, base0, size1, count);
}
...
//	#pragma HLS INTERFACE s_axilite port = count bundle = control
	...
	int count  = 1;
	process_SLR( in, out, xdim0_poisson_kernel_stencil, base0, xdim1_poisson_kernel_stencil, base1, size0, size1, count);
