...
void process_SLR0 (uint512_dt*  arg0, uint512_dt*  arg1,
	...
	derives_calc_ytep_k2( streamArray[2], streamArray_yy[1], streamArray[3], streamArray_yy[2], data_g);
	derives_calc_ytep_k2( streamArray[3], streamArray_yy[2], streamArray[4],streamArray_yy[3], data_g);


	stream_convert_256_512(streamArray[4], wr_buffer, gridsize_da);
