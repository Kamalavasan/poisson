...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 2, sizeof(arg3.data_d), (void*) arg2.data_d ));
    //arg3.dat->size
    printf("fake1");
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 4, sizeof(arg3.data_d), (void*) arg4.data_d ));

    //clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 2, sizeof(cl_mem),  &arg3.data_d ));
