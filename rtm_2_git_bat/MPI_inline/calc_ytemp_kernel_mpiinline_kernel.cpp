...
void ops_par_loop_calc_ytemp_kernel(char const *name, ops_block block, int dim,
  ...
  if (xdim5 != xdim5_calc_ytemp_kernel_h ||
      ydim5 != ydim5_calc_ytemp_kernel_h ||
      xdim6 != xdim6_calc_ytemp_kernel_h ||
      ydim6 != ydim6_calc_ytemp_kernel_h ||
      xdim7 != xdim7_calc_ytemp_kernel_h ||
      ydim7 != ydim7_calc_ytemp_kernel_h) {
  ...
  calc_ytemp_kernel_c_wrapper(p_a0, p_a1, p_a2, p_a3, p_a4, p_a5, p_a6, p_a7,
