...
#endif
#else
void ops_par_loop_calc_ytemp2_kernel_execute(const char *name, ops_block block,
                                             int blockidx_start,
...
#ifdef OPS_DEBUG
  ops_register_args(args, "calc_ytemp2_kernel");
#endif
...
#endif
#ifdef OPS_SOA
          const ACC<float> yy(6, xdim5, ydim5, zdim5,
                              yy_p + n_0 + n_1 * xdim5 + n_2 * xdim5 * ydim5 +
...
#endif
#ifdef OPS_SOA
          ACC<float> k(6, xdim6, ydim6, zdim6,
                       k_p + n_0 + n_1 * xdim6 + n_2 * xdim6 * ydim6 +
                           n_3 * xdim6 * ydim6 * zdim6);
#else
          ACC<float> k(6, xdim6, ydim6, zdim6,
                       k_p + 6 * (n_0 + n_1 * xdim6 + n_2 * xdim6 * ydim6 +
                                  n_3 * xdim6 * ydim6 * zdim6));
#endif
#ifdef OPS_SOA
          ACC<float> ytemp(6, xdim7, ydim7, zdim7,
                           ytemp_p + n_0 + n_1 * xdim7 + n_2 * xdim7 * ydim7 +
