...
void buildOpenCLKernels_fd3d_pml_kernel(int xdim4, int ydim4, int xdim5,
                                        int ydim5, int xdim6, int ydim6,
                                        int xdim7, int ydim7) {
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(buildOpts,
                ...
                "-Dxdim4_fd3d_pml_kernel=%d  -Dydim4_fd3d_pml_kernel=%d  "
                "-Dxdim5_fd3d_pml_kernel=%d  -Dydim5_fd3d_pml_kernel=%d  "
                "-Dxdim6_fd3d_pml_kernel=%d  -Dydim6_fd3d_pml_kernel=%d  "
                "-Dxdim7_fd3d_pml_kernel=%d  -Dydim7_fd3d_pml_kernel=%d ",
                pPath, 32, xdim4, ydim4, xdim5, ydim5, xdim6, ydim6, xdim7,
                ydim7);
      else
        sprintf(buildOpts,
...
void ops_par_loop_fd3d_pml_kernel(char const *name, ops_block block, int dim,
  ...
  buildOpenCLKernels_fd3d_pml_kernel(xdim4, ydim4, xdim5, ydim5, xdim6, ydim6,
                                     xdim7, ydim7);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              3, sizeof(cl_mem), (void *)&arg4.data_d));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              7, sizeof(cl_float), (void *)&dx));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              8, sizeof(cl_float), (void *)&dy));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              9, sizeof(cl_float), (void *)&dz));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              10, sizeof(cl_int), (void *)&nx));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              11, sizeof(cl_int), (void *)&ny));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              12, sizeof(cl_int), (void *)&nz));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              13, sizeof(cl_int), (void *)&pml_width));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              14, sizeof(cl_int), (void *)&half));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              15, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              16, sizeof(cl_int), (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              17, sizeof(cl_int), (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              18, sizeof(cl_int), (void *)&base7));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              19, sizeof(cl_int), (void *)&arg_idx[0]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              20, sizeof(cl_int), (void *)&arg_idx[1]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              21, sizeof(cl_int), (void *)&arg_idx[2]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              22, sizeof(cl_int), (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              23, sizeof(cl_int), (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[1],
                              24, sizeof(cl_int), (void *)&z_size));
