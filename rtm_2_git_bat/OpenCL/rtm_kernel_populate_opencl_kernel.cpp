...
void buildOpenCLKernels_rtm_kernel_populate(int xdim4, int ydim4, int xdim5,
  ...
  if (!isbuilt_rtm_kernel_populate) {
    ...
    printf("Compiling rtm_kernel_populate %d source -- start \n", OCL_FMA);
    ...
    if (pPath != NULL)
      if (OCL_FMA)
        sprintf(
            ...
            "-Dxdim4_rtm_kernel_populate=%d  -Dydim4_rtm_kernel_populate=%d  "
            "-Dxdim5_rtm_kernel_populate=%d  -Dydim5_rtm_kernel_populate=%d  "
            "-Dxdim6_rtm_kernel_populate=%d  -Dydim6_rtm_kernel_populate=%d ",
            pPath, 32, xdim4, ydim4, xdim5, ydim5, xdim6, ydim6);
      else
        sprintf(
            buildOpts,
...
void ops_par_loop_rtm_kernel_populate(char const *name, ops_block block,
  ...
  buildOpenCLKernels_rtm_kernel_populate(xdim4, ydim4, xdim5, ydim5, xdim6,
                                         ydim6);
  ...
  if (globalWorkSize[0] > 0 && globalWorkSize[1] > 0 && globalWorkSize[2] > 0) {
    ...
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              6, sizeof(cl_int), (void *)&nx));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              7, sizeof(cl_int), (void *)&ny));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              8, sizeof(cl_int), (void *)&nz));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              9, sizeof(cl_int), (void *)&base4));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              10, sizeof(cl_int), (void *)&base5));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              11, sizeof(cl_int), (void *)&base6));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              12, sizeof(cl_int), (void *)&arg_idx[0]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              13, sizeof(cl_int), (void *)&arg_idx[1]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              14, sizeof(cl_int), (void *)&arg_idx[2]));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              15, sizeof(cl_int), (void *)&x_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              16, sizeof(cl_int), (void *)&y_size));
    clSafeCall(clSetKernelArg(OPS_instance::getOPSInstance()
                                  ->opencl_instance->OPS_opencl_core.kernel[0],
                              17, sizeof(cl_int), (void *)&z_size));
