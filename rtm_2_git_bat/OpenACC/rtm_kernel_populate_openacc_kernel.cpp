...
void ops_par_loop_rtm_kernel_populate(char const *name, ops_block block,
  ...
  if (xdim4 != xdim4_rtm_kernel_populate_h ||
      ydim4 != ydim4_rtm_kernel_populate_h ||
      xdim5 != xdim5_rtm_kernel_populate_h ||
      ydim5 != ydim5_rtm_kernel_populate_h ||
      xdim6 != xdim6_rtm_kernel_populate_h ||
      ydim6 != ydim6_rtm_kernel_populate_h) {
  ...
  rtm_kernel_populate_c_wrapper(*p_a0, *p_a1, *p_a2, p_a3, p_a4, p_a5, p_a6,
